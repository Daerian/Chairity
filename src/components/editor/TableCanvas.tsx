    ...
    return (
      <main className="flex-1 flex items-center justify-center p-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-event-muted text-sm max-w-xs">
            Configure your tables to start building the seating arrangement.
          </p>
          <button
            onClick={onOpenTableConfig}
            className="px-5 py-2.5 bg-gold-500 text-white rounded-lg hover:bg-gold-600 transition-colors text-sm font-medium"
          >
            Set up tables
          </button>
        </div>
