...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-event-bg flex flex-col items-center justify-center p-6">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-card border border-event-border p-8 space-y-6">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-200 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all text-sm font-medium text-gray-700 disabled:opacity-60"
          >
            {loading ? (
